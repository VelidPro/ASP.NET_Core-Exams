        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BrojNepolozenih = table.Column<int>(nullable: false),
                    BrojPrijavljenihStudenata = table.Column<int>(nullable: false),
                    DatumIspita = table.Column<DateTime>(nullable: false),
                    EvidentiraniRezultati = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_IspitniTermini", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IspitniTermini_Angazovan_AngazovanId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PolaganjaIspita", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PolaganjaIspita_IspitniTermini_IspitniTerminId",
                        column: x => x.IspitniTerminId,
                        principalTable: "IspitniTermini",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PolaganjaIspita_UpisGodine_UpisGodineId",
                        column: x => x.UpisGodineId,
                        principalTable: "UpisGodine",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IspitniTermini_AngazovanId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PolaganjaIspita_IspitniTerminId",
                table: "PolaganjaIspita",
                column: "IspitniTerminId");

            migrationBuilder.CreateIndex(
                name: "IX_PolaganjaIspita_UpisGodineId",
                table: "PolaganjaIspita",
                column: "UpisGodineId");
